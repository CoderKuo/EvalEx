...
public class ExpressionConfiguration {
     ...
     */
    @Builder.Default
    private final boolean binaryAllowed = false;
     ...
     */
    @Builder.Default
    private final boolean singleQuoteStringLiteralsAllowed = false;
    ...
    public final ExpressionConfiguration withAdditionalOperators(
            Pair<String, OperatorIfc>... operators) {
    ...
    public final ExpressionConfiguration withAdditionalFunctions(
            Pair<String, FunctionIfc>... functions) {
