...
class ShuntingYardExceptionsTest extends BaseParserTest {
    ...
    void testUnexpectedToken() {
        List<Token> tokens = ListUtil.of(new Token(1, "x", FUNCTION_PARAM_START));
    ...
    void testMissingPrefixOperand() {
        List<Token> tokens = ListUtil.of(new Token(1, "-", PREFIX_OPERATOR, new PrefixMinusOperator()));
    ...
    void testDoubleStructureOperator() {
        List<Token> tokens =
                ListUtil.of(new Token(1, ".", STRUCTURE_SEPARATOR), new Token(2, ".", STRUCTURE_SEPARATOR));
        assertThatThrownBy(new ShuntingYardConverter("..", tokens, configuration)::toAbstractSyntaxTree)
                .isInstanceOf(ParseException.class)
                .hasMessage("Missing operand for operator");
    }
    ...
    void testStructureFollowsPostfixOperator() {
        List<Token> tokens =
                ListUtil.of(new Token(1, ".", STRUCTURE_SEPARATOR), new Token(2, "!", POSTFIX_OPERATOR));
        assertThatThrownBy(new ShuntingYardConverter("..", tokens, configuration)::toAbstractSyntaxTree)
                .isInstanceOf(ParseException.class)
                .hasMessage("Missing operand for operator");
    }
